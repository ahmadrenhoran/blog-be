...
exports.deletePostById = exports.getPosts = exports.getPostById = exports.updatePost = exports.createPost = void 0;
...
const updatePost = async (postId, userId, title, content, coverImage) => {
...
const getPostById = async (postId, userId) => {
    ...
    if (post.rows.length === 0) {
        throw new errors_1.AppError(`Post not found or you're not authorized to view this post`, 403, "UNAUTHORIZED_UPDATE");
    }
    return post.rows[0];
};
...
const deletePostById = async (postId, userId) => {
    ...
    if (result.rows.length === 0) {
        throw new errors_1.AppError(`Post not found or you're not authorized to delete this post`, 403, "UNAUTHORIZED_UPDATE");
    }
